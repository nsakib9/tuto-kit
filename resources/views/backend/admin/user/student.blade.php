    ...
    <div class="content">
        ...
        <div class="card">
              <div class="card-header">
                <button id="create" class="btn btn-primary">Create Student</button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<form action="{{ url('/admin/user_add?group=student') }}" method="post">
    @csrf
<div id="modale_area"></div>
</form>
<form action="{{ url('/admin/user_update?group=student') }}" method="post">
    @csrf
...
@section('js')
  <script>      
        $('button[id="create"]').click(function(){
            $.get(base_url+'admin/user_modal?group=student',function(data){
                //console.log(data);
        ...
        function edit(id){
          $.get(base_url+'admin/user_modal?group=student&id='+id,function(data){
                //console.log(data);
                $('#modale_area').html('');
