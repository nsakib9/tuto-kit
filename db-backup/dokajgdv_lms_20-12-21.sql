...
CREATE TABLE IF NOT EXISTS `bots` (
  ...
  `hide_actions` tinyint(1) NOT NULL DEFAULT '0',
  `cooldown` int(11) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `bots_owner_type_owner_id_index` (`owner_type`,`owner_id`),
  KEY `bots_thread_id_foreign` (`thread_id`),
  CONSTRAINT `bots_thread_id_foreign` FOREIGN KEY (`thread_id`) REFERENCES `threads` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table lskit_lms.bots: ~0 rows (approximately)
DELETE FROM `bots`;
/*!40000 ALTER TABLE `bots` DISABLE KEYS */;
/*!40000 ALTER TABLE `bots` ENABLE KEYS */;

-- Dumping structure for table lskit_lms.bot_actions
...
CREATE TABLE IF NOT EXISTS `bot_actions` (
  ...
  `triggers` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `bot_actions_owner_type_owner_id_index` (`owner_type`,`owner_id`),
  KEY `bot_actions_bot_id_foreign` (`bot_id`),
  KEY `bot_actions_handler_index` (`handler`),
  KEY `bot_actions_triggers_index` (`triggers`),
  CONSTRAINT `bot_actions_bot_id_foreign` FOREIGN KEY (`bot_id`) REFERENCES `bots` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table lskit_lms.bot_actions: ~0 rows (approximately)
DELETE FROM `bot_actions`;
/*!40000 ALTER TABLE `bot_actions` DISABLE KEYS */;
/*!40000 ALTER TABLE `bot_actions` ENABLE KEYS */;

-- Dumping structure for table lskit_lms.calls
...
CREATE TABLE IF NOT EXISTS `calls` (
  ...
  `teardown_complete` tinyint(1) NOT NULL DEFAULT '0',
  `room_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `room_pin` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `room_secret` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payload` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `call_ended` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `calls_owner_type_owner_id_index` (`owner_type`,`owner_id`),
  KEY `calls_thread_id_foreign` (`thread_id`),
  KEY `calls_call_ended_index` (`call_ended`),
  CONSTRAINT `calls_thread_id_foreign` FOREIGN KEY (`thread_id`) REFERENCES `threads` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table lskit_lms.calls: ~0 rows (approximately)
DELETE FROM `calls`;
/*!40000 ALTER TABLE `calls` DISABLE KEYS */;
/*!40000 ALTER TABLE `calls` ENABLE KEYS */;

-- Dumping structure for table lskit_lms.call_participants
...
CREATE TABLE IF NOT EXISTS `call_participants` (
  ...
  `left_call` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `call_participants_owner_type_owner_id_index` (`owner_type`,`owner_id`),
  KEY `call_participants_call_id_foreign` (`call_id`),
  CONSTRAINT `call_participants_call_id_foreign` FOREIGN KEY (`call_id`) REFERENCES `calls` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table lskit_lms.call_participants: ~0 rows (approximately)
...
-- Dumping structure for table lskit_lms.friends
...
CREATE TABLE IF NOT EXISTS `friends` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `friends_owner_type_owner_id_index` (`owner_type`,`owner_id`),
...
INSERT INTO `friends` (`id`, `owner_type`, `owner_id`, `party_type`, `party_id`, `created_at`, `updated_at`) VALUES
	('458', 'App\\Models\\User', 12, 'App\\Models\\User', 24, NULL, NULL);
...
-- Dumping structure for table lskit_lms.messages
...
CREATE TABLE IF NOT EXISTS `messages` (
  ...
  `reply_to_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `edited` tinyint(1) NOT NULL DEFAULT '0',
  `reacted` tinyint(1) NOT NULL DEFAULT '0',
  `embeds` tinyint(1) NOT NULL DEFAULT '1',
  `extra` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp(6) NULL DEFAULT NULL,
  `updated_at` timestamp(6) NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `messages_owner_type_owner_id_index` (`owner_type`,`owner_id`),
...
INSERT INTO `messages` (`id`, `thread_id`, `owner_type`, `owner_id`, `type`, `body`, `reply_to_id`, `edited`, `reacted`, `embeds`, `extra`, `created_at`, `updated_at`, `deleted_at`) VALUES
	('9526382c-0d60-4391-af3b-0c188b9a76ba', '95243e59-aafa-4d6c-af76-f4f9cb7bf831', 'App\\Models\\User', 24, 94, 'renamed the group to my Group', NULL, 0, 0, 1, NULL, '2021-12-19 11:37:17.075203', '2021-12-19 11:37:17.075203', NULL);
/*!40000 ALTER TABLE `messages` ENABLE KEYS */;

-- Dumping structure for table lskit_lms.message_edits
...
CREATE TABLE IF NOT EXISTS `message_edits` (
  ...
  PRIMARY KEY (`id`),
  KEY `message_edits_message_id_foreign` (`message_id`),
  CONSTRAINT `message_edits_message_id_foreign` FOREIGN KEY (`message_id`) REFERENCES `messages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table lskit_lms.message_edits: ~0 rows (approximately)
DELETE FROM `message_edits`;
/*!40000 ALTER TABLE `message_edits` DISABLE KEYS */;
/*!40000 ALTER TABLE `message_edits` ENABLE KEYS */;

-- Dumping structure for table lskit_lms.message_reactions
...
CREATE TABLE IF NOT EXISTS `message_reactions` (
  ...
  PRIMARY KEY (`id`),
  KEY `message_reactions_owner_type_owner_id_index` (`owner_type`,`owner_id`),
  KEY `message_reactions_message_id_foreign` (`message_id`),
  CONSTRAINT `message_reactions_message_id_foreign` FOREIGN KEY (`message_id`) REFERENCES `messages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table lskit_lms.message_reactions: ~0 rows (approximately)
DELETE FROM `message_reactions`;
/*!40000 ALTER TABLE `message_reactions` DISABLE KEYS */;
/*!40000 ALTER TABLE `message_reactions` ENABLE KEYS */;

-- Dumping structure for table lskit_lms.messengers
DROP TABLE IF EXISTS `messengers`;
CREATE TABLE IF NOT EXISTS `messengers` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `owner_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `owner_id` bigint(20) unsigned NOT NULL,
  `message_popups` tinyint(1) NOT NULL DEFAULT '1',
  `message_sound` tinyint(1) NOT NULL DEFAULT '1',
  `call_ringtone_sound` tinyint(1) NOT NULL DEFAULT '1',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `messengers_owner_type_owner_id_index` (`owner_type`,`owner_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table lskit_lms.messengers: ~2 rows (approximately)
DELETE FROM `messengers`;
/*!40000 ALTER TABLE `messengers` DISABLE KEYS */;
INSERT INTO `messengers` (`id`, `owner_type`, `owner_id`, `message_popups`, `message_sound`, `call_ringtone_sound`, `notify_sound`, `dark_mode`, `online_status`, `ip`, `timezone`, `created_at`, `updated_at`) VALUES
	('9523954f-79f7-4c8b-a8ae-a9e5084d5492', 'App\\Models\\User', 12, 1, 1, 1, 1, 1, 1, NULL, NULL, '2021-12-18 04:10:14', '2021-12-18 04:10:14'),
	('95239aff-79ff-49b5-bbc6-86e6af98425e', 'App\\Models\\User', 24, 1, 1, 1, 1, 1, 1, NULL, NULL, '2021-12-18 04:26:08', '2021-12-18 04:26:08');
...
INSERT INTO `messenger_groups` (`id`, `name`, `admin`, `member`, `created_at`, `updated_at`) VALUES
	(3, 'new groupe', 24, '["37","38","39","36","40","33","47","35","24","31"]', '2021-10-11 06:09:50', '2021-12-18 09:59:36'),
	(4, 'Class Hall', 31, '["24","33","35","36","37","38","39","40","31","42","43","45","46"]', '2021-10-13 05:34:13', '2021-12-18 03:43:41');
...
-- Dumping data for table lskit_lms.migrations: ~42 rows (approximately)
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(37, '2019_10_01_000022_create_friends_table', 18),
	(38, '2019_10_01_000023_create_pending_friends_table', 18),
	(39, '2019_10_01_000024_create_threads_table', 18),
	(40, '2019_10_01_000025_create_participants_table', 18),
	(41, '2019_10_01_000026_create_messages_table', 18),
	(42, '2019_10_01_000027_create_calls_table', 18),
	(43, '2019_10_01_000028_create_call_participants_table', 18),
	(44, '2019_10_01_000029_create_message_edits_table', 18),
	(45, '2019_10_01_000030_create_thread_invites_table', 18),
	(46, '2019_10_01_000031_create_messengers_table', 18),
	(47, '2019_10_01_000032_create_message_reactions_table', 18),
	(48, '2019_10_01_000033_create_bots_table', 18),
	(49, '2019_10_01_000034_create_bot_actions_table', 18);
...
INSERT INTO `options` (`id`, `type`, `title`, `logoimg`, `width`, `height`, `content`, `status`, `url`, `navmenu`, `header`, `footer`, `created_at`, `updated_at`) VALUES
	...
	(27, 'logo', NULL, '1639545633-1209.jpg', '350px', '80px', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-12-15 05:20:33'),
...
-- Dumping structure for table lskit_lms.participants
...
CREATE TABLE IF NOT EXISTS `participants` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `participants_owner_type_owner_id_index` (`owner_type`,`owner_id`),
  KEY `participants_thread_id_foreign` (`thread_id`),
  CONSTRAINT `participants_thread_id_foreign` FOREIGN KEY (`thread_id`) REFERENCES `threads` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table lskit_lms.participants: ~9 rows (approximately)
DELETE FROM `participants`;
/*!40000 ALTER TABLE `participants` DISABLE KEYS */;
INSERT INTO `participants` (`id`, `thread_id`, `owner_type`, `owner_id`, `admin`, `muted`, `pending`, `start_calls`, `send_knocks`, `send_messages`, `add_participants`, `manage_invites`, `manage_bots`, `last_read`, `created_at`, `updated_at`, `deleted_at`) VALUES
	('95243e59-bb2d-4576-97dc-94a2c4172adb', '95243e59-aafa-4d6c-af76-f4f9cb7bf831', 'App\\Models\\User', 24, 1, 0, 0, 0, 0, 1, 0, 0, 0, '2021-12-19 11:37:17.285336', '2021-12-18 12:02:54.293119', '2021-12-19 11:37:17.285503', NULL),
	('95243f30-4380-478d-afc7-375e1c6e5542', '95243f30-4059-49e3-9df3-7f5313ae59f7', 'App\\Models\\User', 31, 1, 0, 0, 0, 0, 1, 0, 0, 0, NULL, '2021-12-18 12:05:14.889118', '2021-12-18 12:05:14.889118', NULL),
	('95243f83-6693-4a38-a3d3-d4b9dcd5c4be', '95243f83-6389-477e-a76d-163b7a2de085', 'App\\Models\\User', 24, 1, 0, 0, 0, 0, 1, 0, 0, 0, '2021-12-19 11:32:54.655136', '2021-12-18 12:06:09.373792', '2021-12-19 11:32:54.655317', NULL),
	('9524404e-2214-4c10-84f8-f3d53305302a', '9524404e-1ea6-4d98-bff2-41190648e9b7', 'App\\Models\\User', 24, 1, 0, 0, 0, 0, 1, 0, 0, 0, '2021-12-19 11:32:48.415842', '2021-12-18 12:08:22.236526', '2021-12-19 11:32:48.416044', NULL),
	('95244096-2eef-4209-95e2-98a463c686d8', '95244096-2be2-427a-b1b3-0fd41f673edf', 'App\\Models\\User', 24, 1, 0, 0, 0, 0, 1, 0, 0, 0, '2021-12-19 11:32:30.551363', '2021-12-18 12:09:09.455342', '2021-12-19 11:32:30.551548', NULL),
	('95260c29-83a3-42ed-9124-725198584ccd', '95243e59-aafa-4d6c-af76-f4f9cb7bf831', 'App\\Models\\User', 33, 0, 0, 0, 0, 0, 1, 0, 0, 0, NULL, '2021-12-19 09:34:13.441080', '2021-12-19 09:34:13.441080', NULL),
	('95261021-101a-418a-b970-f80aada46689', '95243e59-aafa-4d6c-af76-f4f9cb7bf831', 'App\\Models\\User', 35, 0, 0, 0, 0, 0, 1, 0, 0, 0, NULL, '2021-12-19 09:45:18.985853', '2021-12-19 09:45:18.985853', NULL),
	('952636bc-0f17-4895-9385-76dcc35ae23a', '95243e59-aafa-4d6c-af76-f4f9cb7bf831', 'App\\Models\\User', 36, 0, 0, 0, 0, 0, 1, 0, 0, 0, NULL, '2021-12-19 11:33:15.907384', '2021-12-19 11:33:15.907384', NULL),
	('952636bd-13ec-47a5-8b5e-596a79688c70', '95243e59-aafa-4d6c-af76-f4f9cb7bf831', 'App\\Models\\User', 37, 0, 0, 0, 0, 0, 1, 0, 0, 0, NULL, '2021-12-19 11:33:16.573342', '2021-12-19 11:33:16.573342', NULL);
...
-- Dumping structure for table lskit_lms.pending_friends
...
CREATE TABLE IF NOT EXISTS `pending_friends` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pending_friends_sender_type_sender_id_index` (`sender_type`,`sender_id`),
  KEY `pending_friends_recipient_type_recipient_id_index` (`recipient_type`,`recipient_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table lskit_lms.pending_friends: ~0 rows (approximately)
...
-- Dumping structure for table lskit_lms.threads
...
-- Dumping data for table lskit_lms.threads: ~5 rows (approximately)
DELETE FROM `threads`;
/*!40000 ALTER TABLE `threads` DISABLE KEYS */;
INSERT INTO `threads` (`id`, `type`, `subject`, `image`, `add_participants`, `invitations`, `calling`, `messaging`, `knocks`, `chat_bots`, `lockout`, `created_at`, `updated_at`, `deleted_at`) VALUES
	('95243e59-aafa-4d6c-af76-f4f9cb7bf831', 2, 'my Group', NULL, 0, 0, 1, 1, 1, 0, 0, '2021-12-18 12:02:54.256236', '2021-12-19 11:37:17.079193', NULL),
	('95243f30-4059-49e3-9df3-7f5313ae59f7', 2, 'asdfsf', NULL, 0, 0, 1, 1, 1, 0, 0, '2021-12-18 12:05:14.886057', '2021-12-18 12:05:14.886057', NULL),
	('95243f83-6389-477e-a76d-163b7a2de085', 2, 'sdafsdaf', NULL, 0, 0, 1, 1, 1, 0, 0, '2021-12-18 12:06:09.370403', '2021-12-18 12:06:09.370403', NULL),
	('9524404e-1ea6-4d98-bff2-41190648e9b7', 2, 'dasfadsfsadf', NULL, 0, 0, 1, 1, 1, 0, 0, '2021-12-18 12:08:22.233497', '2021-12-18 12:08:22.233497', NULL),
	('95244096-2be2-427a-b1b3-0fd41f673edf', 2, 'dasdsdaf', NULL, 0, 0, 1, 1, 1, 0, 0, '2021-12-18 12:09:09.452441', '2021-12-18 12:09:09.452441', NULL);
/*!40000 ALTER TABLE `threads` ENABLE KEYS */;

-- Dumping structure for table lskit_lms.thread_invites
DROP TABLE IF EXISTS `thread_invites`;
CREATE TABLE IF NOT EXISTS `thread_invites` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `thread_invites_code_unique` (`code`),
  KEY `thread_invites_owner_type_owner_id_index` (`owner_type`,`owner_id`),
  KEY `thread_invites_thread_id_foreign` (`thread_id`),
  KEY `thread_invites_expires_at_index` (`expires_at`),
  CONSTRAINT `thread_invites_thread_id_foreign` FOREIGN KEY (`thread_id`) REFERENCES `threads` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table lskit_lms.thread_invites: ~0 rows (approximately)
DELETE FROM `thread_invites`;
/*!40000 ALTER TABLE `thread_invites` DISABLE KEYS */;
/*!40000 ALTER TABLE `thread_invites` ENABLE KEYS */;
