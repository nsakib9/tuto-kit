...
class ChatifyMessenger
{
    ...
    public function fetchMessagesQueryGroup($user_id){
        return Message::where('to_id','88888'.$user_id);
    }

        public function fetchMessagesQueryGroupCustom($user_id){
        return Message::where('to_id','77777'.$user_id);
    }
    ...
    public function getContactItem($messenger_id, $user){
        ...
        return [
            'type' => $user->role_name,
            'content' => view('Chatify::layouts.listItem', [
                            'get' => 'users',
                            'user' => $user,
